...
std::vector<PerfIssue> issues = {
    {PerfIssue::FPS, true}, {PerfIssue::FPS, false}, {PerfIssue::FPS, true}, {PerfIssue::FPS, true},
    {PerfIssue::NETWORK, true}, {PerfIssue::NETWORK, false}, {PerfIssue::NETWORK, true}, {PerfIssue::NETWORK, false},
    {PerfIssue::NETWORK, true}, {PerfIssue::INPUT_DELAY, true}, {PerfIssue::INPUT_DELAY, true},
    {PerfIssue::INPUT_DELAY, false}, {PerfIssue::FPS, true}, {PerfIssue::NETWORK, true}, {PerfIssue::INPUT_DELAY, true}
};
