...
namespace ImGui
{
    ...
    IMGUI_API void          RenderArrowPointingAt(ImDrawList* draw_list, ImVec2 poys, ImVec2 half_sz, ImGuiDir direction, ImU32 col);
    ...
    IMGUI_API bool          SelectButtons(const char* label, const char* label_1, ImColor text_color, const char* percent, const char* message, float percent_circle, const ImVec2& size_arg = ImVec2(0, 0), ImGuiButtonFlags flags = 0);
    IMGUI_API bool          Button_Back(const char* label, const char* text, ImTextureID image, const ImVec2& size_arg = ImVec2(0, 0), ImGuiButtonFlags flags = 0);
    IMGUI_API bool          Help_Button(const char* label, ImTextureID image, const ImVec2& size_arg = ImVec2(0, 0), ImGuiButtonFlags flags = 0);
    IMGUI_API bool          Info_Button(const char* label, ImTextureID image, const ImVec2& size_arg = ImVec2(0, 0), ImGuiButtonFlags flags = 0);
    IMGUI_API bool          Warning_Button(const char* label, ImTextureID image, const ImVec2& size_arg = ImVec2(0, 0), ImGuiButtonFlags flags = 0);
    IMGUI_API bool          Succes_Button(const char* label, ImTextureID image, const ImVec2& size_arg = ImVec2(0, 0), ImGuiButtonFlags flags = 0);
    IMGUI_API bool          Enjoy_Button(const char* label, ImTextureID image, const ImVec2& size_arg = ImVec2(0, 0), ImGuiButtonFlags flags = 0);
    IMGUI_API bool          Exit_Button(const char* label, ImTextureID image, const ImVec2& size_arg = ImVec2(0, 0), ImGuiButtonFlags flags = 0);
    IMGUI_API bool          Circle_Button(const char* label, ImTextureID image, const ImVec2& size_arg = ImVec2(0, 0), ImGuiButtonFlags flags = 0);
