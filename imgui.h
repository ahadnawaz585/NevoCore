...
namespace ImGui
{
    ...
    IMGUI_API void          SetNextWindowViewport(ImGuiID viewport_id);          // set next window background color alpha. helper to easily override the Alpha component of ImGuiCol_WindowBg/ChildBg/PopupBg. you may also use ImGuiWindowFlags_NoBackground.
